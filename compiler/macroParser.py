        ...
        if MACRO_SYMBOL*2 in line:
            ...
            if MACRO_SYMBOL in line:
                try:
                    ...
                    display(
                        "Line %d: Malformed Macro Application [%s]" % (ix, str(v)))
            else:
                nline = line
...
if __name__ in "__main__":
    # with open(r"F:\ICE-CQ AI\AlexandermothProject\em\em121\00\data\tu0Event\CombosCastingMelee.nack") as inf:
    #    test = inf.read()
